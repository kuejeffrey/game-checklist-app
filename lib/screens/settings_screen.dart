  ...
  Future<void> _confirmReset(BuildContext context) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'This will clear all your tasks, XP, and streak. Your progress will be reset. This cannot be undone.',
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              '"Progress, not perfection. Every small step you take matters. This app is here to celebrate what you do, not judge what you don\'t."',
              style: TextStyle(
